...
export const ActivitySchema = z.object({
    ...
    maxAge: z.number({ error: "Indtast en minimumsalder mellem 0 og 100" }).min(0, { error: "Indtast en maximumsalder mellem 0 og 100" }).max(100, { error: "Indtast en maximumsalder mellem 0 og 100" }),
    instructorId: z.enum(["1", "2", "3", "4"], { error: "Vælg en instruktør" }),
    maxParticipants: z.number({ error: "Indtast en minimumsalder mellem 0 og 100" }).min(1, { error: "Indtast en maximum af deltagere" }),
